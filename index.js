...
function sortHotelsByPricing(hotelsObj, pricing) {
  if (pricing === 'low-to-high') {
    return hotelsObj.sort((a, b) => a.price - b.price);
  } else {
    return hotelsObj.sort((a, b) => b.price - a.price);
  }
}

function sortHotelsByRating(hotelsObj, rating) {
  if (rating === 'low-to-high') {
    return hotelsObj.sort((a, b) => a.rating - b.rating);
  } else {
    return hotelsObj.sort((a, b) => b.rating - a.rating);
  }
}

function sortHotelsByReviews(hotelsObj, reviews) {
  if (reviews === 'least-to-most') {
    return hotelsObj.sort((a, b) => a.reviews - b.reviews);
  } else {
    return hotelsObj.sort((a, b) => b.reviews - a.reviews);
  }
}
...
app.get('/hotels/filter/amenity', (req, res) => {
  ...
  let sortedHotels = hotels.filter((hotel) =>
...
app.get('/hotels/filter/country', (req, res) => {
  ...
  let sortedHotels = hotels.filter((hotel) =>
    filterHotelsByCountry(hotel, country)
  );
  res.json({
    hotels: sortedHotels,
  });
